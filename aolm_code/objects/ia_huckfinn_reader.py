...
# Purpose: Defines AOLM Text Reader to read Internet Archive (IA) versions of
...
class IAHuckFinnReader(AOLMTextReader):
...
def main():
    ...
    reader = IAHuckFinnReader(test_filepath + test_file)
    reader.read()
