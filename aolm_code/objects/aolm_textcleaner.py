...
# Purpose: Object used to parse and clean text from file and string
...
class AOLMTextCleaner(object):

	# Constructor

	def __init__(self, p_text_object, p_stopwords_type=None, p_tokenization_type=None):

		# 0. Save parameters
		self.m_text_object = p_text_object
