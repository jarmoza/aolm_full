...
# NOTE: This will be broken down by functionality in the next release of this code - J. Armoza; October 8, 2021
...
def distance_from_sentence_to_sentence(p_sent1_wordlist, p_sent2_wordlist, p_model):
	...
	# 4. Create a distance vector between projected points on the first sentence surface and the second sentences' words
