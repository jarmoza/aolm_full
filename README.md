# The Art of Literary Modeling: Data Quality

## Overview

Welcome to the repository for 'The Art of Literary Modeling: Data Quality' (AoLM), a PhD project and dissertation by [Jonathan Armoza](https://jonathanarmoza.com/) that develops a framework for measuring and assessing the data quality of corpora of digital literature in digital humanities research.

This repository accompanies the [published dissertation text](https://www.proquest.com/docview/3355452934) and contains the code used for the experiments and tutorial demonstrations described in the text.
...
|------|----------|--------------------|----------------------------------|----------|
| [lexical validity](aolm_code/data_quality/core/dq_metrics/dataset_validity/lexical_validity.py) | [intrinsic](#intrinsic-data-quality) | - [accuracy](#accuracy-dimension) | - [believability](#believability-dimension) | evaluates token-level correctness by comparing text against external lexical resources |
| [record consensus](aolm_code/data_quality/core/dq_metrics/dataset_consistency/consistency_recordconsensus.py) | [representational](#representational-data-quality) | - [representational consistency](#representational-consistency-dimension) | - [interpretability](#interpretability-dimension) | measures cross-edition consistency by comparing shared textual features across versions |
| [metadata sufficiency](aolm_code/data_quality/core/dq_metrics/dataset_completeness/metadata_sufficiency.py) | [contextual](#contextual-data-quality) | - [completeness](#completeness-dimension) <br> - [value-added](#value-added-dimension) | - [relevancy](#relevancy-dimension) | assesses completeness and consistency of metadata across records and repositories |
| [record counts to control records](aolm_code/data_quality/core/dq_metrics/dataset_completeness/recordcounts_to_controlrecords.py) | [contextual](#contextual-data-quality) | - [completeness](#completeness-dimension) | - [accuracy](#accuracy-dimension) | evaluates dataset completeness by comparing structural counts to a reference edition|
| [authorial signature](aolm_code/data_quality/core/dq_metrics/dataset_signature/authorial_signature.py) | [representational](#representational-data-quality) | - [representational consistency](#representational-consistency-dimension) | - [interpretability](#interpretability-dimension) | quantifies stylistic variation by comparing normalized word-frequency distributions across texts|
| [legomena](aolm_code/data_quality/core/dq_metrics/dataset_signature/legomena.py) | [representational](#representational-data-quality) | - [interpretability](#interpretability-dimension) | - [representational consistency](#representational-consistency-dimension) | analyzes low-frequency lexical distributions to identify anomalies and distinctive patterns|
